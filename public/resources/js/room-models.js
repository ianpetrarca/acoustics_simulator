    ...
    let marble = {
      ...
      up: 'marble',
       ...
       this.el.addEventListener('click', function (evt) {
        ...
        var sceneEl = document.querySelector('a-scene');
        sceneEl.querySelector('#wall').setAttribute('material', {color: 'white', wireframe: true,shader:'flat'});
        sceneEl.querySelector('#ground').setAttribute('material', {color: 'white', wireframe: true,shader:'flat'});
    });
  }
});
    ...
    let wood = {
      ...
      up: 'wood-panel',
       ...
       this.el.addEventListener('click', function (evt) {
        ...
        var sceneEl = document.querySelector('a-scene');
        sceneEl.querySelector('#wall').setAttribute('material', {color: 'yellow', wireframe: true,shader:'flat'});
        sceneEl.querySelector('#ground').setAttribute('material', {color: 'yellow', wireframe: true,shader:'flat'});
    });
  }
});
